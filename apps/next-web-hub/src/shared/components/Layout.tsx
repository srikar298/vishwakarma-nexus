          ...
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              <div className="flex items-center gap-6 mr-4 border-r border-stone-100 pr-8">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 w-64 bg-white border border-stone-100 shadow-2xl rounded-3xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 z-50">
                    <Link href="/vision" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                    ...
                    <Link href="/heritage" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                    ...
                    <Link href="/legends" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                ...
                <Link href="/knowledge" className="text-stone-600 hover:text-vermilion transition-colors font-semibold">{t('nav.knowledge')}</Link>
                <Link href="/directory" className="text-stone-600 hover:text-vermilion transition-colors font-semibold">{t('nav.directory')}</Link>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 w-64 bg-white border border-stone-100 shadow-2xl rounded-3xl p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 z-50">
                    <Link href="/events" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                      <div className="p-2 bg-stone-100 rounded-xl text-stone-600 group-hover/item:bg-stone-900 group-hover/item:text-white transition-colors">
                        <Calendar size={18} />
                      </div>
                      <div>
                    ...
                    <Link href="/network" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                      <div className="p-2 bg-stone-100 rounded-xl text-stone-600 group-hover/item:bg-stone-900 group-hover/item:text-white transition-colors">
                        <Users size={18} />
                      </div>
                      <div>
                    ...
                    <Link href="/empowerment" className="flex items-center gap-4 p-4 hover:bg-stone-50 rounded-2xl transition-all group/item">
                      <div className="p-2 bg-stone-100 rounded-xl text-stone-600 group-hover/item:bg-stone-900 group-hover/item:text-white transition-colors">
                        <Flag size={18} />
                      </div>
                      <div>
              ...
              <div className="flex items-center gap-4">
                <LanguageSwitcher />
                <Link href="/donors" className="hidden lg:block text-stone-500 hover:text-vermilion transition-colors font-black uppercase tracking-widest text-xs px-2">{t('donors.page_title' as never, 'Community Donors')}</Link>
                <button 
          ...
          {isMenuOpen && (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto space-y-6 pr-2 mb-4">
                 ...
                 <Link href="/directory" onClick={() => setIsMenuOpen(false)} className="block px-6 py-4 text-stone-600 hover:bg-stone-50 rounded-2xl font-black text-sm uppercase tracking-widest transition-all">{t('nav.directory')}</Link>

                 <div>
                    <h4 className="text-[10px] font-black text-stone-400 uppercase tracking-widest px-4 mb-2">{t('nav.network')}</h4>
                     <div className="grid gap-2">
                       <Link href="/events" onClick={() => setIsMenuOpen(false)} className="block px-6 py-4 text-stone-600 hover:bg-stone-50 rounded-2xl font-black text-sm uppercase tracking-widest transition-all">{t('nav.events')}</Link>
                       <Link href="/gallery" onClick={() => setIsMenuOpen(false)} className="block px-6 py-4 text-stone-600 hover:bg-stone-50 rounded-2xl font-black text-sm uppercase tracking-widest transition-all">{t('nav.gallery')}</Link>
                       <Link href="/donors" onClick={() => setIsMenuOpen(false)} className="block px-6 py-4 text-stone-600 hover:bg-stone-50 rounded-2xl font-black text-sm uppercase tracking-widest transition-all text-vermilion">{t('donors.page_title' as never, 'Community Donors')}</Link>
                     </div>
                  </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-8 col-span-1 md:col-span-2">
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm font-medium">
                  <li><Link href="/directory" className="text-stone-500 hover:text-white transition-colors">Artisan Directory</Link></li>
                  <li><Link href="/network" className="text-stone-500 hover:text-white transition-colors">Network Hub</Link></li>
                  <li><Link href="/empowerment" className="text-stone-500 hover:text-white transition-colors">Empowerment</Link></li>
                  <li><Link href="/founder" className="text-stone-500 hover:text-white transition-colors">The Founder</Link></li>
                  <li><Link href="/donors" className="text-stone-500 hover:text-white transition-colors">{t('donors.page_title' as never, 'Community Donors')}</Link></li>
                </ul>
              </div>
            </div>
          </div>
